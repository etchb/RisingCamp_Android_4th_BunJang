...
class DialogUserOut(context: Context) {
...
//        dlg.setCancelable(false)    //다이얼로그의 바깥 화면을 눌렀을 때 다이얼로그가 닫히지 않도록 함
        ...
        val txtTitle: TextView = dlg.findViewById(R.id.dia_txt_title)
        val txtContent: TextView = dlg.findViewById(R.id.dia_txt_content)
